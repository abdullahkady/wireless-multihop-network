# Credit: https://gist.github.com/egorf/66d88056a9d703928f93
...
class Bluetoothctl:
    ...
    def get_output(self, command, pause = 0):
        ...
        # We split using a string. If
        # self.child.before is not a string, it breaks
        self.child.before = str(self.child.before)
